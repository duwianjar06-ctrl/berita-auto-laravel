...
class PublicController extends Controller
{
    ...
    public function article(string $slug)
    {
        ...
        return view('article', ['article' => $article, 'categories' => $this->navigationCategories()]);
    }
    ...
    public function category(string $category)
    {
        ...
        return view('category', ['cat' => $cat, 'articles' => $articles, 'categories' => $this->navigationCategories()]);
    }
    ...
    public function sitemap(): Response
    {
        ...
        foreach (Category::orderBy('name')->get() as $c) $urls[] = ['loc' => url('/kategori/'.rawurlencode($c->name))];
        foreach (Article::where('generation_status', 'published')->whereNotNull('site_published_at')->latest('site_published_at')->get() as $a) {
            $urls[] = ['loc' => route('article', $a->slug), 'lastmod' => $a->site_published_at->toAtomString()];
        }
