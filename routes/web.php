...
Route::middleware(EnsureAdmin::class)->group(function () {
    ...
    Route::get('/admin-berita/{article}/edit', [AdminController::class, 'edit'])->name('admin.news.edit');
    Route::put('/admin-berita/{article}', [AdminController::class, 'update'])->name('admin.news.update');
    Route::post('/admin-berita/{article}/approve', [AdminController::class, 'approve'])->name('admin.news.approve');
    Route::post('/admin-berita/{article}/reject', [AdminController::class, 'reject'])->name('admin.news.reject');
    Route::post('/admin-berita/{article}/publish', [AdminController::class, 'publish'])->name('admin.news.publish');
    Route::post('/admin-berita/{article}/schedule', [AdminController::class, 'schedule'])->name('admin.news.schedule');
